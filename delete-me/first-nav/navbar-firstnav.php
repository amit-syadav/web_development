...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark navbar-template" >
...
<div class="container">
    <a href="#"><img src="http://ideapreneurindia.com/wp-content/uploads/2016/11/cropped-idealogo-1.png" alt="logo"></a>
    ...
    <nav class="navbar navbar-expand-lg bg-dark sticky-top navbar-dark">
      ...
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#menu" aria-controls="bs-example-navbar-collapse-1" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      ...
      <div class="collapse navbar-collapse" id = "menu">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">STORIES IN PICTURE</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">STARTUP FUNDING AND INVESTMENT</a>
          </li>
        </ul>
      </div>
  ...
  <!-- Bottom nav bar -->
    ...
    <nav class="navbar fixed-bottom navbar-expand-lg bg-dark navbar-dark ustify-content-between">


      <span class="navbar-text mr-auto">
        COPYRIGHT 2019 | IDEAPRENEURINDIA ALL RIGHTS RESERVED.
      </span>
      ...
      <div class="collapse navbar-collapse" id = "menu">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="..\bottom-nav\contact-us.php">CONTACT US</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="..\bottom-nav\privacy-terms.php">PRIVACY /TERMS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="..\bottom-nav\site-map.php">SITEMAP</a>
          </li>
